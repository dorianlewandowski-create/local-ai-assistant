...
const SpawnHelperAgentParams = z.object({
  purpose: z
    .string()
    .min(1)
    .describe('The specific sub-task for the helper agent (e.g., "Researching AppleScript for Spotify").'),
...
export const spawnHelperAgent: Tool<typeof SpawnHelperAgentParams> = {
  ...
  description:
    'Spawn a specialized sub-agent to handle a specific part of a complex task. Use this for parallel processing or to isolate risky operations.',
