...
const UpdateSoulParams = z.object({
  content: z
    ...
    .describe('The full new content for the HOT memory (memory.md).'),
})

export const updateSoul: Tool<typeof UpdateSoulParams> = {
  name: 'update_soul',
  description:
    'Update your persistent HOT memory (identity and confirmed preferences). Use this when a pattern is confirmed or a major preference changes.',
...
export const logCorrection: Tool<typeof LogCorrectionParams> = {
  name: 'log_correction',
  description:
    'Log a correction to your memory. Use this whenever the user says "No, do X instead" or points out a mistake.',
